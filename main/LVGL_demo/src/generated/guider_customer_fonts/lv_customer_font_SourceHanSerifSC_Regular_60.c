...
#ifndef LV_CUSTOMER_FONT_SOURCEHANSERIFSC_REGULAR_60
#define LV_CUSTOMER_FONT_SOURCEHANSERIFSC_REGULAR_60 1
#endif

#if LV_CUSTOMER_FONT_SOURCEHANSERIFSC_REGULAR_60
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 960, .box_w = 51, .box_h = 47, .ofs_x = 4, .ofs_y = -1}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t lv_customer_font_SourceHanSerifSC_Regular_60 = {
#else
lv_font_t lv_customer_font_SourceHanSerifSC_Regular_60 = {
#endif
...
#endif /*#if LV_CUSTOMER_FONT_SOURCEHANSERIFSC_REGULAR_60*/
